                ...
                <section>
                    ...
                    <div className='multiple-input-container'>
                        ...
                        <input
                            id='cats'
                            value={undefined}
                            onChange={() => { formik.setFieldValue('petType', "cats") }}
                        ...
                        <input
                            id='dogs'
                            value={undefined}
                            onChange={() => { formik.setFieldValue('petType', "dogs") }}
                            onBlur={formik.handleBlur("petType")}
                            type="radio"
                    ...
                    <label htmlFor="pets-owned">Which animals can the Pet live with in the Same Household?</label>
                    {/* errors */}
                    <div className="form-validation">
                    ...
                    <div className='multiple-input-container'>
                        ...
                        <input
                            id='cats-owned'
                            value={undefined}
                            onChange={() => { formik.setFieldValue('petTorrelance', "cat") }}
                        ...
                        <input
                            id='dogs-owned'
                            value={undefined}
                            onChange={() => { formik.setFieldValue('petTorrelance', "dog") }}
                            onBlur={formik.handleBlur("petTorrelance")}
                            type="radio"
                        ...
                        <input
                            id='none-owned'
                            value={undefined}
                            onChange={() => { formik.setFieldValue('petTorrelance', "none") }}
                            onBlur={formik.handleBlur("petTorrelance")}
                            type="radio"
                        ...
                        <input
                            id='both-owned'
                            value={undefined}
                            onChange={() => { formik.setFieldValue('petTorrelance', "both") }}
                            onBlur={formik.handleBlur("petTorrelance")}
                            type="radio"
                    ...
                    <label htmlFor="garden">Does the pet need a dedicated Garden?</label>
                    {/* errors */}
                    <div className="form-validation">
                    ...
                    <label htmlFor="active">Can the Pet live a Very active Lifestyle? </label>
                    {/* errors */}
                    <div className="form-validation">
